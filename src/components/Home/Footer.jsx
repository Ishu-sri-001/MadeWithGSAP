    ...
    <footer className="dark-bg text-white h-fit max-md:pb-[15vw] px-[2vw] w-full" id='footer'>
      <div className='flex max-md:flex-col justify-between text-white pb-[10%]'>
          <div className='flex flex-col w-[35%] max-md:w-full'>
            <p className='text-[3vw] max-md:pl-[2vw] max-md:pt-[5vw] max-md:text-[7vw] pb-[1.5vw]'>Never miss what's next</p>

            <div className='flex justify-between w-full pb-[1.5vw] max-md:pt-[3vw] max-md:px-[2vw]'>
              <p className='text-[1.5vw] max-md:text-[4.5vw]'>Your email</p>
              <div className='text-white flex items-end gap-[0.5vw]'>
                    ...
                    <p className='text-[0.9vw] max-md:text-[3vw]'>SUBMIT</p>
              </div>
            </div>
          ...
          <div className='flex max-md:grid max-md:grid-cols-2 max-md:gap-x-[50vw] text-[0.9vw] max-md:text-[3vw] justify-between gap-[8vw] pl-[20%] max-md:pl-[4vw] w-[65%] pr-[15%] max-md:pt-[10vw]'>
            <div className='flex flex-col text-neutral-500'>
                <p>SOCIAL</p>
                <div className='flex flex-col gap-[0.5vw] max-md:gap-[2vw] max-md:pt-[3vw] pt-[1vw] text-left text-white'>
            ...
            <div className='flex flex-col text-neutral-500'>
                <p>PAGES</p>
                <div className='flex flex-col gap-[0.5vw] pt-[1vw] text-left max-md:gap-[2vw] max-md:pt-[3vw] text-white'>
            ...
            <div >
             ...
             <div className='flex flex-col text-neutral-500 '>
                <p>CONTACT</p>
                <div className='flex flex-col gap-[0.5vw] pt-[1vw] items-center text-left text-white max-md:gap-[2vw] max-md:pt-[3vw]'>
                  <p className='cursor-pointer hover:text-[#C9FE6E] text-nowrap max-md:pl-[16vw]'>REACH US</p>
